...
import { add_new_flashcard } from "../../actions/flashcards";
...
class AddFlashcard extends Component {
  ...
  async onSubmit(e) {
    ...
    const completed = await this.props.add_new_flashcard({
      deckId,
      term,
      meaning,
      reading,
  ...
  render() {
    ...
    const { isAuthenticated, authLoading, decksLoading } = this.props;
    const {
      term,
      meaning,
      reading,
