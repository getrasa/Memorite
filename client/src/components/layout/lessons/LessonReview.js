...
import Input from "../review/Input";
import DisplayWindow from "./DisplayWindow";
import TermInformation from "../review/TermInformation";
import createFlashcards from "../review/Flashcards";
import {
  mapIntervalToLevel,
  mapIntervalToHours,
  addHoursToDate
...
class LessonReview extends React.Component {
  ...
  setNextFlashcard(input) {
    ...
    if (isCorrect && !isInQueue) {
      ...
      this.updateFlashcard(fullFlashcard, "passed", deckId);
    }
  ...
  render() {
    ...
    const { current = {}, remaining, correct } = Flashcards;
